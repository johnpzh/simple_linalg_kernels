...
# export SPARSE_FILE_NAME1="${COMET_ROOT}/integration_test/data/test_rank2.mtx"
...
export SPARSE_FILE_NAME0="/qfs/projects/cenate/tmp/zhen.peng/datasets/suitesparse/pwtk/pwtk.mtx"
export SPARSE_FILE_NAME1="/qfs/projects/cenate/tmp/zhen.peng/datasets/suitesparse/pwtk/pwtk.mtx"
