module {
  ...
  ^bb41:  // pred: ^bb40
    ...
    omp.parallel {
      omp.wsloop schedule(static) for  (%arg0) : i64 = (%2) to (%222) step (%3) {
      ...
      ^bb3:  // pred: ^bb2
        ...
        %235 = llvm.getelementptr %165[%231] : (!llvm.ptr, i64) -> !llvm.ptr, f64
