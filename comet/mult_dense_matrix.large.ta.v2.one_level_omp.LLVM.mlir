module {
  ...
  llvm.func @main() {
    ...
    %8 = llvm.mlir.constant(400 : index) : i64
    %9 = llvm.mlir.constant(8000 : index) : i64
    %10 = llvm.mlir.zero : !llvm.ptr
    %11 = llvm.getelementptr %10[3200000] : (!llvm.ptr) -> !llvm.ptr, f64
    ...
    %22 = llvm.getelementptr %21[80000] : (!llvm.ptr) -> !llvm.ptr, f64
    ...
    %33 = llvm.getelementptr %32[1600000] : (!llvm.ptr) -> !llvm.ptr, f64
