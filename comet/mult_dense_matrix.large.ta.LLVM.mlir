module {
  ...
  ^bb9(%54: i64):  // 2 preds: ^bb8, ^bb10
    %55 = llvm.icmp "slt" %54, %9 : i64
    llvm.cond_br %55, ^bb10, ^bb11
  ^bb10:  // pred: ^bb9
    %56 = llvm.mul %52, %9  : i64
  ...
  ^bb20:  // pred: ^bb19
    ...
    omp.parallel {
      ...
      ^bb1:  // pred: ^bb0
        llvm.br ^bb2(%4 : i64)
      ^bb2(%76: i64):  // 2 preds: ^bb1, ^bb3
        %77 = llvm.icmp "slt" %76, %7 : i64
        llvm.cond_br %77, ^bb3, ^bb4
      ^bb3:  // pred: ^bb2
        omp.parallel {
          omp.wsloop for  (%arg1) : i64 = (%4) to (%9) step (%5) {
            %79 = llvm.intr.stacksave : !llvm.ptr
            llvm.br ^bb1
          ^bb1:  // pred: ^bb0
