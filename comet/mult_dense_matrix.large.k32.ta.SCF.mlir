module {
  func.func @main() {
    ...
    %alloc_2 = memref.alloc() {alignment = 32 : i64} : memref<4000x32xf64>
    %alloc_3 = memref.alloc() {alignment = 32 : i64} : memref<8000x32xf64>
    linalg.fill ins(%cst_1 : f64) outs(%alloc : memref<8000x4000xf64>)
    linalg.fill ins(%cst_0 : f64) outs(%alloc_2 : memref<4000x32xf64>)
    linalg.fill ins(%cst : f64) outs(%alloc_3 : memref<8000x32xf64>)
    ...
    scf.parallel (%arg0) = (%c0) to (%c8000) step (%c1) {
      scf.for %arg1 = %c0 to %c4000 step %c1 {
        scf.for %arg2 = %c0 to %c32 step %c1 {
          ...
          %3 = memref.load %alloc_2[%arg1, %arg2] : memref<4000x32xf64>
          %4 = memref.load %alloc_3[%arg0, %arg2] : memref<8000x32xf64>
          %5 = arith.mulf %2, %3 : f64
          %6 = arith.addf %4, %5 : f64
          memref.store %6, %alloc_3[%arg0, %arg2] : memref<8000x32xf64>
        }
      }
      scf.reduce 
    }
