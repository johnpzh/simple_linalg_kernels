module {
  ...
  ^bb31:  // pred: ^bb30
    ...
    %208 = llvm.add %203, %3  : i64
    llvm.br ^bb30(%208 : i64)
  ^bb32:  // pred: ^bb30
    %209 = llvm.add %201, %3  : i64
  ...
  ^bb37:  // pred: ^bb36
    ...
    %217 = llvm.add %212, %3  : i64
    llvm.br ^bb36(%217 : i64)
  ^bb38:  // pred: ^bb36
    %218 = llvm.add %210, %3  : i64
    llvm.br ^bb34(%218 : i64)
  ^bb39:  // pred: ^bb34
    llvm.br ^bb40(%2 : i64)
  ^bb40(%219: i64):  // 2 preds: ^bb39, ^bb41
    %220 = llvm.icmp "slt" %219, %6 : i64
    llvm.cond_br %220, ^bb41, ^bb42
  ^bb41:  // pred: ^bb40
    %221 = llvm.call @getTime() : () -> f64
    %222 = llvm.load %45 : !llvm.ptr -> i64
    omp.parallel {
      omp.wsloop for  (%arg0) : i64 = (%2) to (%222) step (%3) {
        %225 = llvm.intr.stacksave : !llvm.ptr
        llvm.br ^bb1
      ^bb1:  // pred: ^bb0
        %226 = llvm.add %arg0, %3  : i64
        %227 = llvm.getelementptr %105[%arg0] : (!llvm.ptr, i64) -> !llvm.ptr, i64
        %228 = llvm.load %227 : !llvm.ptr -> i64
        %229 = llvm.getelementptr %105[%226] : (!llvm.ptr, i64) -> !llvm.ptr, i64
        %230 = llvm.load %229 : !llvm.ptr -> i64
        llvm.br ^bb2(%228 : i64)
      ^bb2(%231: i64):  // 2 preds: ^bb1, ^bb6
        %232 = llvm.icmp "slt" %231, %230 : i64
        llvm.cond_br %232, ^bb3, ^bb7
      ^bb3:  // pred: ^bb2
        %233 = llvm.getelementptr %120[%231] : (!llvm.ptr, i64) -> !llvm.ptr, i64
        %234 = llvm.load %233 : !llvm.ptr -> i64
        llvm.br ^bb4(%2 : i64)
      ^bb4(%235: i64):  // 2 preds: ^bb3, ^bb5
        %236 = llvm.icmp "slt" %235, %7 : i64
        llvm.cond_br %236, ^bb5, ^bb6
      ^bb5:  // pred: ^bb4
        %237 = llvm.getelementptr %165[%231] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        %238 = llvm.load %237 : !llvm.ptr -> f64
        %239 = llvm.mul %234, %7  : i64
        %240 = llvm.add %239, %235  : i64
        %241 = llvm.getelementptr %188[%240] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        %242 = llvm.load %241 : !llvm.ptr -> f64
        %243 = llvm.mul %arg0, %7  : i64
        %244 = llvm.add %243, %235  : i64
        %245 = llvm.getelementptr %200[%244] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        %246 = llvm.load %245 : !llvm.ptr -> f64
        %247 = llvm.fmul %238, %242  : f64
        %248 = llvm.fadd %246, %247  : f64
        %249 = llvm.mul %arg0, %7  : i64
        %250 = llvm.add %249, %235  : i64
        %251 = llvm.getelementptr %200[%250] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        llvm.store %248, %251 : f64, !llvm.ptr
        %252 = llvm.add %235, %3  : i64
        llvm.br ^bb4(%252 : i64)
      ^bb6:  // pred: ^bb4
        %253 = llvm.add %231, %3  : i64
        llvm.br ^bb2(%253 : i64)
      ^bb7:  // pred: ^bb2
        llvm.intr.stackrestore %225 : !llvm.ptr
        llvm.br ^bb8
      ^bb8:  // pred: ^bb7
        omp.yield
      }
    ...
    llvm.call @printElapsedTime(%221, %223) : (f64, f64) -> ()
    %224 = llvm.add %219, %3  : i64
